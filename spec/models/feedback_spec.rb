...
RSpec.describe Feedback, type: :model do
    ...
    before(:each) do
        ...
        @feedback = Feedback.create(feedback: "You must slow down and break harder when you turn on the right at the third turn", meeting_id: @meeting.id)
    end
    ...
    context "validation" do
        ...
        it "is valid with valid attributes" do
          ...
          it "should not be valid with an inexisting feedback" do
            bad_feedback = Feedback.create(feedback: "", meeting_id: @meeting.id)
            expect(bad_feedback).not_to be_valid
            expect(bad_feedback.errors.include?(:feedback)).to eq(true)
          end
        end
